...
<div class="tab-panel" id="tab-info">
  ...
  <div class="card">
    ...
    <ul style="margin: 8px 0 8px 20px; line-height: 1.8;">
      ...
      <li>Can also be triggered <strong>on demand via DTMF</strong>, independent of the schedule above (which doesn't have to be hourly - any cron pattern works). See the <a href="https://github.com/N6LKA/AllStar-Herald/wiki/Time-and-Weather-Announcements#dtmf-setup" target="_blank">wiki</a> for the exact <code>rpt.conf</code> line to add.</li>
    </ul>
  </div>
</div>
...
<div class="tab-panel" id="tab-timeweather">
  <div class="card">
    ...
    <div class="banner-info">
      To play this announcement on demand via DTMF (independent of the schedule below), add a function to your node's <code>rpt.conf</code> - see the wiki's <a href="https://github.com/N6LKA/AllStar-Herald/wiki/Time-and-Weather-Announcements#dtmf-setup" target="_blank">DTMF Setup</a> guide for the exact line to add.
    </div>
